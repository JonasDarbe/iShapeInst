...
__all__ = ["load_coco_json", "load_sem_seg", "convert_to_coco_json", "register_ishape_instances"]
...
def register_ishape_instances(name, metadata, json_file, image_root):
    """
    ...
    MetadataCatalog.get(name).set(json_file=json_file, image_root=image_root, **metadata)
...
def register_all_ishape_intance():
    metadata = get_metadata()
    for (dataset_name, (json_file, image_root)) in _PREDEFINED_SPLITS_ADE20K_PANOPTIC.items():
...
if __name__ == "__main__":
    ...
    #print(meta)
    #dicts = DatasetCatalog.get("cow_instance_train")

    #evaluator_type = MetadataCatalog.get("cow_instance_train").evaluator_type
    #print(evaluator_type)

    #dicts = MetadataCatalog.get("cow_instance_train")
    #meta = get_metadata()
    #print(dicts)
    #dicts = load_coco_json(sys.argv[1], sys.argv[2], sys.argv[3])
    #json_file, image_root, dataset_name=None, extra_annotation_keys=None
    json_file = "/home/data3/data_wy/ishape_dataset/log/train/coco_format-mask_encoding=rle-instances_2017.json"
    image_root = "/home/data3/data_wy/ishape_dataset/log/train/image"
    dataset_name = "ishape_instance_train"

    dicts = load_coco_json(json_file, image_root, dataset_name)
